<?php $title = 'RapidNote - Sell currency'; ?>
                            ...
                            <form class='form' v-if='showSell'>
                                ...
                                <div class="form-check form-check-inline" v-for='rate in rates' :key='rate.id'>
                                    <input class="form-check-input" type="radio" name="inlineRadioOptions"
                                        id="inlineRadio1" value="" @click='getSellingRate(rate.id)'>
                                ...
                                <div class="mt-4 item">
                                    Currency choosen: <br>
                                    Selling rate: <span>{{ rate }} ghc</span> <img src="./public/img/ghana-flag.png"
